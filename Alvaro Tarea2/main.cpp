...
int main( int argc, char* args[] )
{
    ...
    if((window = SDL_CreateWindow("Image Loading", 100, 100, 320/*WIDTH*/, 200/*HEIGHT*/, SDL_WINDOW_RESIZABLE | SDL_RENDERER_PRESENTVSYNC)) == NULL)
    {
        return 20;
    }
    //SDL Renderer
    ...
    //Init textures
    int w=0,h=0;
     background = IMG_LoadTexture(renderer,"dungeon.png");
    ...
    rect_dragon.x = 230; rect_dragon.y = 60; rect_dragon.w = w; rect_dragon.h = h;
    bool sprint = false;
    //Main Loop
    while(true)
    {
